...
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-gapx/tags). For example,

```javascript
import gapx from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gapx@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gapx/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-gapx/actions/workflows/test.yml?query=branch:v0.2.1
...
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-gapx/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-gapx/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-gapx/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-gapx/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-gapx/blob/esm/README.md
